...
//    public var fetchRequest: NSFetchRequest<AnyObject> { return internalController.fetchRequest }
...
//    public subscript(indexPath: IndexPath) -> T { return internalController.object(at: indexPath) as! T }
...
//    */
//    public init(fetchRequest: NSFetchRequest<AnyObject>, managedObjectContext context: NSManagedObjectContext, sectionNameKeyPath: String? = nil, cacheName: String? = nil) {
...
//    */
//    public func setDelegate<U: FetchedResultsControllerDelegate where U.T == T>(_ delegate: U) {
...
//
//    private let internalController: NSFetchedResultsController<AnyObject>
...
//    }
//
//    override func controllerWillChangeContent(_ controller: NSFetchedResultsController<AnyObject>) {
//        delegate?.fetchedResultsControllerWillChangeContent(owner)
//    }
//
//    override func controllerDidChangeContent(_ controller: NSFetchedResultsController<AnyObject>) {
//        delegate?.fetchedResultsControllerDidChangeContent(owner)
//    }
//
//    override func controller(_ controller: NSFetchedResultsController<AnyObject>, didChange anObject: AnyObject, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
...
//    }
//
//    override func controller(_ controller: NSFetchedResultsController<AnyObject>, didChange sectionInfo: NSFetchedResultsSectionInfo, atSectionIndex sectionIndex: Int, for type: NSFetchedResultsChangeType) {
